...
GO
ALTER TABLE [HumanResources].[EmployeePayHistory]  WITH NOCHECK ADD  CONSTRAINT [FK_EmployeePayHistory_Employee_BusinessEntityID] FOREIGN KEY([BusinessEntityID])
