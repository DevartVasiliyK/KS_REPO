...
GO
ALTER TABLE [HumanResources].[EmployeeDepartmentHistory]  WITH NOCHECK ADD  CONSTRAINT [FK_EmployeeDepartmentHistory_Department_DepartmentID] FOREIGN KEY([DepartmentID])
...
GO
ALTER TABLE [HumanResources].[EmployeeDepartmentHistory]  WITH NOCHECK ADD  CONSTRAINT [FK_EmployeeDepartmentHistory_Employee_BusinessEntityID] FOREIGN KEY([BusinessEntityID])
